...
/datum/clockwork_scripture/invoke_sevtug/scripture_effects()
	...
	playsound(invoker, 'sound/f13music/quest.ogg', 50, 0)
	var/hum = get_sfx('sound/f13items/holodisk_cursed.ogg') //like playsound, same sound for everyone affected
...
/datum/clockwork_scripture/invoke_nezbere/scripture_effects()
	...
	playsound(invoker, 'sound/f13items/holodisk_cursed.ogg', 50, 0)

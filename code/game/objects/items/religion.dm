...
/obj/item/weapon/storage/box/itemset/crusader
	name = "Boxed Crusader's armor set" //i can't into ck2 references
	desc = "A large box of artifacts with a shipping label from Transylvania, presumably containing ancient armor that was likely meant to be displayed in a pre-war museum."

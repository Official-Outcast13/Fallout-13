...
/obj/item/weapon/melee/classic_baton/vampirekiller/afterattack(target, mob/user, proximity_flag)
	if(ishuman(target) && proximity_flag)
		playsound(get_turf(src), 'sound/weapons/bullwhip.ogg', 75, 1, -1)
		var/mob/living/carbon/human/H = target
		H.drop_all_held_items()
		H.visible_message("<span class='danger'>[user] disarms [H]!</span>", "<span class='userdanger'>[user] disarmed you!</span>")
	..()
...
/obj/item/weapon/melee/classic_baton/vampirekillerchain/afterattack(target, mob/user, proximity_flag)
	if(ishuman(target) && proximity_flag)
		playsound(get_turf(src), 'sound/weapons/bullwhip.ogg', 75, 1, -1)
		var/mob/living/carbon/human/H = target
		H.drop_all_held_items()
...
/obj/item/weapon/melee/bullwhip/afterattack(target, mob/user, proximity_flag)
	if(ishuman(target) && proximity_flag)
		var/mob/living/carbon/human/H = target
		H.drop_all_held_items()
		H.visible_message("<span class='danger'>[user] disarms [H]!</span>", "<span class='userdanger'>[user] disarmed you!</span>")
...
/obj/item/weapon/melee/classic_baton/truevampirekiller/afterattack(target, mob/user, proximity_flag)
	if(ishuman(target) && proximity_flag)
		playsound(get_turf(src), 'sound/weapons/bullwhip.ogg', 75, 1, -1)
		var/mob/living/carbon/human/H = target
		H.drop_all_held_items()
...
/obj/item/weapon/melee/classic_baton/warclub
	...
	block_chance = 50
	w_class = WEIGHT_CLASS_NORMAL
	attack_verb = list("bashed", "struck", "whacked", "beaten")
	hitsound = 'sound/f13weapons/pan.ogg'
	var/stunforce = 7

/obj/item/weapon/melee/classic_baton/warclub/afterattack(target, mob/user, proximity_flag)
	if(ishuman(target) && proximity_flag)
		playsound(get_turf(src), 'sound/f13weapons/pan.ogg', 75, 1, -1)
		var/mob/living/carbon/human/H = target
		H.drop_all_held_items()
		H.visible_message("<span class='danger'>[user] disarms [H]!</span>", "<span class='userdanger'>[user] disarmed you!</span>")
	..()

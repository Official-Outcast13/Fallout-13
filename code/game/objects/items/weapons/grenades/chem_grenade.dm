...
/obj/item/weapon/grenade/chem_grenade/smithmix
	name = "Smith's Special Mix"
	desc = "Crafted and refined deep in a dusty cabin in the Mojave Wasteland, this grenade was designed by a very angry man. Unfortunately he was as smart as he was pissed."
	stage = READY


/obj/item/weapon/grenade/chem_grenade/smithmix/New()
	..()
	var/obj/item/weapon/reagent_containers/glass/beaker/bluespace/B1 = new(src)
	var/obj/item/weapon/reagent_containers/glass/beaker/bluespace/B2 = new(src)

	B1.reagents.add_reagent("facid", 40)
	B1.reagents.add_reagent("sacid", 20)
	B1.reagents.add_reagent("sugar", 15)
	B1.reagents.add_reagent("curare", 40)
	B2.reagents.add_reagent("stablemutationtoxin", 30)

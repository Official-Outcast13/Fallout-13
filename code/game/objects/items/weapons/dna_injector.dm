...
/obj/item/weapon/dnainjector/telemut
	name = "\improper DNA injector (Psyker.)"
	desc = "Super brain man!"
	add_mutations_static = list(TK)

/obj/item/weapon/dnainjector/telemut/darkbundle
	name = "\improper DNA injector (Psyker.)"
	desc = "It’s an energy field created by all living things. It surrounds us and penetrates us; it binds the wasteland together."

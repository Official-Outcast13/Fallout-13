...
/obj/item/clothing/mask/vape
	name = "E-Cigarette"
//	to_chat(desc = "A classy and highly sophisticated electronic cigarette, for classy and dignified gentlemen. A warning label reads \"Warning: Do not fill with flammable materials.\"", < i'd vape to that.)
	icon = 'icons/obj/clothing/masks.dmi'
	icon_state = null
	item_state = null
	var/chem_volume = 100

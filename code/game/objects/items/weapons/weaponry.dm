...
/obj/item/weapon/tomahawk
	name = "Tomahawk"
	desc = "A traditional single-handed ax hailing from primarily Native American origins. This one's handle is wrapped in a multicolored cloth and adorned with a large fluorescent feather held on by two chain links. Chop chop."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "tomahawk"
	item_state = "tomahawk"
	slot_flags = SLOT_BELT
...
/obj/item/weapon/alucardsword
	name = "Greatsword"
	desc = "A sword that, oddly enough seems to have been a mishmash of a longsword and rapier in one weapon. The blade is still quite sharp on the edges but rather skinnily tapered down to the hilt. The material looks to be forged from carbon steel and is presumably made with a full tang, but there's no dating the construction simply by examining it. Among it's other noteworthy features is the ghostly yellow aura pulsing around it, looking rather tranquil when not in use."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "alucardsword"
	item_state = "alucardsword"
	slot_flags = SLOT_BELT
	force = 250
	throwforce = 60
	embed_chance = 100
...
/obj/item/weapon/zimsword
	name = "Kaladbolg"
	desc = "Said to have once belonged to Fergus mac Róich of Irish mythology, Kaladbolg is a mysterious relic of immeasurable power that grants it's wielder supreme reflexes to block the majority of incoming projectiles, and enough force behind it's swings to cut carbon steel. Among it's other noteworthy features is the ghostly violet aura pulsing around it, looking rather tranquil when not in use."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "zimsword"
	item_state = "zimsword"
	slot_flags = SLOT_BACK
...
/obj/item/weapon/igonsword
	name = "Longsword"
	desc = "Slightly blackened with an engraved wooden pommel, and slightly larger cross-guard, the prized possession of one lost in time."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "igonsword"
	item_state = "igonsword"
	slot_flags = SLOT_BACK
	force = 50
	throwforce = 40
	embed_chance = 20
...
/obj/item/weapon/crissaegrim
	name = "Crissaegrim"
	desc = "A sword emanating a dark red energy. You don't know what that aura is, but somehow it makes this blade sharper than a scalpel."
	icon = 'icons/obj/weapons.dmi'
	icon_state = "crissaegrim"
	item_state = "crissaegrim"
	slot_flags = SLOT_BELT
	force = 200
	throwforce = 30
	embed_chance = 0
	...
	attack_verb = list("gutted", "sliced", "chopped", "slashed", "sawed", "diced")
	hitsound = 'sound/weapons/slash.ogg'
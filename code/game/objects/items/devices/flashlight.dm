...
/obj/item/device/flashlight/seclite
	name = "Maglite"
	desc = "A large, durable flashlight used by civillians and major companies alike before the nuclear fallout."
	icon_state = "seclite"
	item_state = "seclite"
	force = 20 // Not as good as a stun baton.
...
/obj/item/device/flashlight/lantern
	...
	icon_state = "lantern"
	item_state = "lantern"
	desc = "A very old oil-based lantern."

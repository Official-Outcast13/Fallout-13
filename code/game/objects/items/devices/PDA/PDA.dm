...
/obj/item/device/pda
	name = "Pip-Boy 3000"
	desc = "An advanced personal-data assistant, the Pip-Boy 3000 was granted to those lucky enough to survive the apocalypse in the safety of Vaults. No Vault Dweller should go without them. Unless they're a corpse, of course."
	...
	var/note = "Congratulations, you are the proud owner of the Vault-Tec Pip-Boy 3000!" //Current note in the notepad function
	var/notehtml = ""

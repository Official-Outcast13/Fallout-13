...
/obj/item/clothing/suit/armor/ranger
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list(melee = 60, bullet = 60, laser = 40, energy = 40, bomb = 30, bio = 0, rad = 50, fire = 30, acid = 30)
	put_on_delay = 20
	strip_delay = 20
	self_weight = 2
...
/obj/item/clothing/suit/bio_suit/advancedsciencesuit
	...
	slowdown = 1
	allowed = list(/obj/item/weapon/gun/energy,/obj/item/weapon/reagent_containers/spray/pepper,/obj/item/weapon/gun/ballistic,/obj/item/ammo_box,/obj/item/ammo_casing,/obj/item/weapon/melee/baton,/obj/item/weapon/restraints/handcuffs,/obj/item/device/flashlight/seclite,/obj/item/weapon/melee/classic_baton/telescopic,/obj/item/weapon/kitchen/knife/combat,/obj/item/weapon/tank/internals/emergency_oxygen)
	armor = list(melee = 50, bullet = 50, laser = 65, energy = 65, bomb = 50, bio = 50, rad = 60, fire = 60, acid = 100)
	flags_inv = HIDEGLOVES|HIDESHOES|HIDEJUMPSUIT
	strip_delay = 70
	put_on_delay = 70
	resistance_flags = ACID_PROOF
...
/obj/item/clothing/suit/armor/power_armor/advanced
	...
	icon_state = "advancedpa"
	item_state = "advancedpa"
	armor = list(melee = 60, bullet = 60, laser = 70, energy = 70, bomb = 60, bio = 100, rad = 60, fire = 60, acid = 60)
	self_weight = 20
...
/obj/item/clothing/suit/armor/power_armor/superadvanced
	...
	icon_state = "superadvancedpa"
	item_state = "superadvancedpa"
	armor = list(melee = 70, bullet = 70, laser = 75, energy = 75, bomb = 75, bio = 100, rad = 80, fire = 80, acid = 80)
	self_weight = 13
...
/obj/item/clothing/suit/armor/power_armor/shocktrooper
	...
	icon_state = "shocktrooperpa"
	item_state = "shocktrooperpa"
	armor = list(melee = 80, bullet = 80, laser = 75, energy = 75, bomb = 75, bio = 100, rad = 90, fire = 80, acid = 80)
	self_weight = 12
...
/obj/item/clothing/suit/armor/power_armor/tesla
	...
	icon_state = "teslapa"
	item_state = "teslapa"
	armor = list(melee = 65, bullet = 65, laser = 70, energy = 70, bomb = 60, bio = 100, rad = 60, fire = 60, acid = 60)
	self_weight = 15

/* NCR Armor */

/obj/item/clothing/suit/armor/ncrsergeant
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list(melee = 55, bullet = 55, laser = 45, energy = 45, bomb = 20, bio = 0, rad = 30, fire = 30, acid = 30)
	put_on_delay = 40
	strip_delay = 40
	resistance_flags = FIRE_PROOF
	self_weight = 7
...
/obj/item/clothing/suit/armor/power_armor/sierra/initialize()
    ..()
    START_PROCESSING(SSobj, src)

/obj/item/clothing/suit/armor/power_armor/sierra/process()
    if(iscarbon(loc))
        var/mob/living/carbon/M = loc
        if(M.health < M.maxHealth)
            M.adjustBruteLoss(-0.2) //Heal that poor bastard
...
/obj/item/clothing/suit/armor/power_armor/t45d
	...
	icon_state = "t45darmor"
	item_state = "t45darmor"
	armor = list(melee = 60, bullet = 60, laser = 50, energy = 40, bomb = 50, bio =100, rad = 40, fire = 50, acid = 50)
	self_weight = 30
...
/obj/item/clothing/suit/armor/power_armor/t51b
	...
	icon_state = "t51barmor"
	item_state = "t51barmor"
	armor = list(melee = 70, bullet = 70, laser = 60, energy = 50, bomb = 60, bio = 100, rad = 60, fire = 60, acid = 60)
	self_weight = 25
...
/obj/item/clothing/suit/armor/power_armor/t60
	...
	icon_state = "t60armor"
	item_state = "t60armor"
	armor = list(melee = 80, bullet = 80, laser = 70, energy = 60, bomb = 60, bio = 100, rad = 75, fire = 70, acid = 70)
	self_weight = 25

/* Legion Armor */

/obj/item/clothing/suit/armor/legrecruit
	...
	armor = list(melee = 30, bullet = 30, laser = 40, energy = 40, bomb = 60, bio = 50, rad = 50, fire = 50, acid = 50)
	put_on_delay = 60
	strip_delay = 60
	self_weight = 3

/obj/item/clothing/suit/armor/legprime
	name = "prime legionary armor"
	desc = "A set of legion armor that appears to be in better condition and reinforced with metal plates."
	icon_state = "recruit"
	item_state = "recruit"
	body_parts_covered = CHEST|GROIN|LEGS|FEET
	armor = list(melee = 25, bullet = 45, laser = 40, energy = 40, bomb = 60, bio = 50, rad = 50, fire = 50, acid = 50)
	put_on_delay = 60
	strip_delay = 60
	self_weight = 3

/obj/item/clothing/suit/armor/legvexil
	...
	item_state = "vexil"
	body_parts_covered = CHEST|GROIN|LEGS|FEET
	armor = list(melee = 45, bullet = 45, laser = 30, energy = 40, bomb = 40, bio = 30, rad = 30, fire = 30, acid = 30)
	put_on_delay = 60
	strip_delay = 60
	self_weight = 5

/obj/item/clothing/suit/armor/legdecan
	name = "legion decanus armor"
	desc = "The armor appears to be based on a suit of Caesar's Legion veteran armor."
	icon_state = "vexil"
	item_state = "vexil"
	body_parts_covered = CHEST|GROIN|LEGS|FEET
...
/obj/item/clothing/suit/armor/legcenturion
	...
	item_state = "centurion"
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list(melee = 60, bullet = 60, laser = 45, energy = 45, bomb = 70, bio = 70, rad = 40, fire = 40, acid = 40)
	put_on_delay = 60
	strip_delay = 60
	self_weight = 10

/obj/item/clothing/suit/armor/leglegate
	...
	item_state = "legate"
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list(melee = 70, bullet = 70, laser = 70, energy = 70, bomb = 75, bio = 75, rad = 30, fire = 40, acid = 40)
	put_on_delay = 60
	strip_delay = 60
	resistance_flags = FIRE_PROOF
	self_weight = 25
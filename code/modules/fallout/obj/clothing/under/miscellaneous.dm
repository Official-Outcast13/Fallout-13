...
/obj/item/clothing/under/f13/police
	...
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list(melee = 20, bullet = 15, laser = 10, energy = 10, bomb = 10, bio = 10, rad = 10, fire = 20, acid = 20)
	can_adjust = 0
...
/obj/item/clothing/under/rolandclothesremake
	...
	item_color = "rolandclothesremake"
	can_adjust = 0
...
/obj/item/clothing/under/f13/mercadv //Male version
	...
	item_color = "merca_m"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list(melee = 15, bullet = 10, laser = 10, energy = 10, bomb = 10, bio = 0, rad = 10, fire = 10, acid = 5)
	can_adjust = 0
	self_weight = 3
...
/obj/item/clothing/under/f13/ncr
	...
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list(melee = 10, bullet = 10, laser = 5, energy = 5, bomb = 5, bio = 0, rad = 0, fire = 5, acid = 5)
	icon_state = "overcoat"
	item_state = "lb_suit"
	item_color = "overcoat"
	can_adjust = 1
...
/obj/item/clothing/under/f13/general
	...
	item_color = "general"
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list(melee = 20, bullet = 20, laser = 15, energy = 10, bomb = 15, bio = 10, rad = 10, fire = 10, acid = 10)
	can_adjust = 0
	self_weight = 3

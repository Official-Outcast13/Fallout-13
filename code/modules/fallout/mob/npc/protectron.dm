...
/mob/living/simple_animal/hostile/mrgutsy
	name = "Mr. Gutsy"
	desc = "A true patriotic killing machine. Clad in green and the shining stars of the U.S. of A. Commies watch out!"
	icon = 'icons/fallout/mobs/animal.dmi'
	icon_living = "gutsy"
	icon_state = "gutsy"
	icon_dead = "gutsy_d"
	...
	environment_smash = 0
	speak_chance = 20
	speak = list("Who's ready to have their ass kicked?!", "You better run, you commie-loving bastard!", "This is the sorriest base I've ever been on. Get to cleaning, private!", "Another fantastic day on God's green Earth!", "God bless America!", "There's nothing better than the smell of fresh plasma in the morning.", "Kill 'em all, and let God sort them out!", "Every day is a good day to die!", "Are you ready to die for your country you commie sunovabitch?!", "You've just made my day!", "Pain is just weakness leaving the body.", "There's nothing I like better than making some poor bastard die for his country.")
	speak_emote = list("synthesizes", "yells")
	emote_hear = list("shifts its many eyes about.")
	emote_see = list("scans the environment.")

...
/obj/item/weapon/paper/crumpled/hinttwo
	icon_state = "scrap_bloodied"
	name = "crumpled note"
...
/obj/item/weapon/paper/crumpled/re1
	icon_state = "scrap_bloodied"
	name = "crumpled note"
	info = "We've been here for nearly a week clocking in at five days, and we're already running low on medical supplies. Brad's leg is fucked and we don't have a stimpak to treat it, let alone a brace. I can only pray that we've got enough ammunition to tide those fucking things over, they aren't like the regular ghouls.. not even the irradiated ones. If I'm not around when you find this, I've hollowed out the wall in the room you just came in through. I've tucked away my gun and a small bit of ammunition, I don't expect to live much longer but I hope it can be of use to someone else.."

/obj/item/weapon/paper/crumpled/re2
	icon_state = "scrap_bloodied"
	name = "crumpled note"
	info = "December's latest test has proven very fruitful, the subjects have gained a taste for human flesh and could possibly be deemed as viable biological weapons for use against larger factions such as the Enclave. Hunter will be most pleased."

/obj/item/weapon/paper/crumpled/re3
	icon_state = "scrap"
	name = "crumpled note"
	info = "They've been pumping me full of the same mutagen that created our masterpieces, and they've got the nerve to consider me a monster? I'll rid this already desolate earth of it's selfish survivors and rebuild it anew in the image of Hunter.. or perhaps myself once I overthrow him. Leaving me in charge of this facility will prove to be his downfall, as well as the rest of the wastes."

/obj/item/weapon/paper/crumpled/re4
	icon_state = "scrap"
	name = "crumpled note"
	info = "The trophy room's been infested with the arachnids John's had us testing for a few weeks now, he's gone completely out of his mind and has been feeding them the staff members that don't comply with his demands immediately. Get yourself out of here, while you still can!"

/obj/item/weapon/paper/crumpled/re5
	icon_state = "scrap"
	name = "crumpled note"
	info = "The mutagen doesn't seem to be killing him no matter how much I put in his drinks, each day it just rots away more of his flesh and seems to heighten his pain tolerance, at the cost of violent moodswings and gradually unwinding his psyche even more than it had been when he first employed me. I can only pray someone will arrive and finish the job one day.."

/obj/item/weapon/paper/crumpled/re6
	icon_state = "scrap_bloodied"
	name = "crumpled note"
	info = "When we answered the distress signal sent out by those military boys, we had no idea in hell what we were dealing with. John motherfucking Wolf, who was reportedly killed in a shootout with local police in a sleepy town after a shooting spree that spanned over two weeks, has wiped out nearly all of our squad. We've been separated from the others and barricaded into this depressing little library; with nothing but chittering and clicking on the other side of the door. How this bastard is alive is beyond any of us, but we aren't going to go down without a fight of some kind."
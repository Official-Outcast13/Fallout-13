...
/mob/living/simple_animal/hostile/russian/ranged/johnwolf
	name = "John Wolf"
	desc = "Probably the most hated thing in the Wasteland at any given time, John Wolf once again walks the ruined earth as a corpse and is hell-bent on seeking his revenge against humanity. Too bad his fashion sense is still stupid in death."
	icon_state = "johnwolf"
	icon_living = "johnwolf"
	icon_dead = "johnwolf_d"
	maxHealth = 2000
	health = 2000
	rapid = 0
	casingtype = /obj/item/ammo_casing/a357
	loot = list(/obj/item/weapon/storage/belt/johnholster/full, /mob/living/simple_animal/hostile/johntyrant, /obj/item/stack/caps/random)

...
/obj/item/weapon/gun/magic/staff/spellblade
	name = "Elder blade"
	desc = "This beautiful blade was gifted to a champion of gods unknown, scriptures line every single part, to even wield it is to take it's knowledge directly into your mind, voices and whispers normally follow suit, with simply having this weapon in one's possession. Most certainly, it is cursed, and holds an unnatural power none can grasp with ease."

/obj/aiming_overlay
	...
	var/obj/item/not_aiming_with //Fix for broken variable
	...
	var/target_permissions = TARGET_CAN_RADIO|TARGET_CAN_CLICK // Permission bitflags.
...
/obj/aiming_overlay/proc/update_aiming()
	...
	if(!(aiming_with in owner) || (istype(owner, /mob/living/carbon/human) && (istype(not_aiming_with, /obj/item/weapon/gun))))

...
/obj/item/clothing/mask/tribalpaintpurple
	name = "Purple war paint"
	desc = "Typically worn by tribals, this Native American-esque paint is applied around the wearer's eyes presumably to boost morale. Or just make you look nuts."
	icon_state = "tribalpaintpurple"
	item_state = "tribalpaintpurple"
	w_class = WEIGHT_CLASS_SMALL

/obj/item/clothing/mask/tribalpaintred
	name = "Red war paint"
	desc = "Typically worn by tribals, this Native American-esque paint is applied around the wearer's eyes presumably to boost morale. Or just make you look nuts."
	icon_state = "tribalpaintred"
	item_state = "tribalpaintred"
	w_class = WEIGHT_CLASS_SMALL

/obj/item/clothing/mask/tribalpaintgreen
	name = "Green war paint"
	desc = "Typically worn by tribals, this Native American-esque paint is applied around the wearer's eyes presumably to boost morale. Or just make you look nuts."
	icon_state = "tribalpaintgreen"
	item_state = "tribalpaintgreen"
	w_class = WEIGHT_CLASS_SMALL

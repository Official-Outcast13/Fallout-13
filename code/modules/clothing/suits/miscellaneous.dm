...
/obj/item/clothing/suit/mikecoat
	name = "Trenchcoat"
	desc = "A very 80's beige-brown trenchcoat complete with oversized pockets. Come on, Mon'Ami."
	pockets = /obj/item/weapon/storage/internal/pocket/big/coat
	icon_state = "mikecoat"
	item_state = "mikecoat"

/obj/item/clothing/suit/liquidarmor
	name = "Ballistic armor"
	desc = "A very advanced suit of body armor crafted from a mixture of kevlar and dyneema for maximum durability and resistance against nearly any projectile."
	pockets = /obj/item/weapon/storage/internal/pocket/big/coat
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list(melee = 100, bullet = 100, laser = 100,energy = 100, bomb = 100, bio = 100, rad = 100, fire = 100, acid = 100)
	icon_state = "liquidarmor"
	item_state = "liquidarmor"

/obj/item/clothing/suit/hunterjacket
	name = "Trenchcoat"
	desc = "A beige trench coat. It seemingly resembles a jacket worn by an NCR Veteran Ranger, but something is off about it."
	pockets = /obj/item/weapon/storage/internal/pocket/big/coat
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list(melee = 50, bullet = 60, laser = 40,energy = 40, bomb = 30, bio = 30, rad = 30, fire = 20, acid = 20)
	icon_state = "hunterjacket"
	item_state = "hunterjacket"

/obj/item/clothing/suit/leonjacket
	name = "Bomber jacket"
	desc = "A classic brown leather jacket with rich tan fur lining the cuffs, collar and hem for added warmth and style."
	pockets = /obj/item/weapon/storage/internal/pocket/big/coat
	icon_state = "leonjacket"
	item_state = "leonjacket"

/obj/item/clothing/suit/tribalshamancloak
	name = "Tribal Shaman's cloak"
	desc = "A very simply constructed cloak woven from an unidentified fabric, frayed and bearing several rips due to it's use over time. It has a large brass coin modified to function as a clasp, keeping it together at the wearer's neck."
	pockets = /obj/item/weapon/storage/internal/pocket/big/coat
	icon_state = "tribalshamancloak"
	item_state = "tribalshamancloak"

/obj/item/clothing/suit/bespinjacket
	name = "Engineer's jacket"
	desc = "A lightweight work jacket that offers mild protection against the wasteland's weather."
	pockets = /obj/item/weapon/storage/internal/pocket/big/coat
	icon_state = "bespinjacket"
	item_state = "bespinjacket"
	allowed = list(/obj/item/weapon/dnainjector)

/obj/item/clothing/suit/zimjacket
	name = "Zip-Up jacket"
	desc = "A simple summer zip-up pullover jacket, made of a fabulous purple synthetic material. Seems like it could hold something concealed in it's pockets."
	pockets = /obj/item/weapon/storage/internal/pocket/big/coat
	icon_state = "zimjacket"
	item_state = "zimjacket"

/obj/item/clothing/suit/mikeduster
	name = "Duster"
	desc = "A worn and slightly frayed duster coat that appears to have seen heavy use throughout it's lifetime."
	pockets = /obj/item/weapon/storage/internal/pocket/big/coat
	icon_state = "mikeduster"
	item_state = "mikeduster"
...
/obj/item/clothing/suit/hooded/crimsonking
	name = "Crimson robes"
	desc = "Vibrant crimson red robes adorned with the symbol of their owner and decorated with golden trim."
	icon_state = "crimsonking"
	item_state = "crimsonking"
	togglename = "hood"
	body_parts_covered = ARMS|CHEST
	hoodtype = /obj/item/clothing/head/hooded/crimsonkinghood
	armor = list(melee = 60, bullet = 60, laser = 60, energy = 60, bomb = 65, bio = 60, rad = 60, fire = 70, acid = 90)

/obj/item/clothing/head/hooded/crimsonkinghood
	name = "Crimson hood"
	desc = "A stunningly crimson red hood belonging to a robe, but the face is eerily blacked out hiding the wearer completely from view."
	icon_state = "crimsonkinghood"
	item_state = "crimsonkinghood"
	flags_inv = HIDEHAIR|HIDEEARS

/obj/item/clothing/suit/hooded/puristrobes
	name = "Brown hooded robes"
	desc = "Deep coffee colored robes with a large hood to obscure the wearer's face, primarily to protect their clothing from harsh desert elements and to traverse the wastes anonymously."
	icon_state = "puristrobes"
	item_state = "puristrobes"
	togglename = "hood"
	allowed = list(/obj/item/weapon/dnainjector)
	body_parts_covered = ARMS|CHEST
	hoodtype = /obj/item/clothing/head/hooded/puristhood
	pockets = /obj/item/weapon/storage/internal/pocket/big/coat

/obj/item/clothing/head/hooded/puristhood
	name = "Hood"
	desc = "The hood of a deep coffee colored robe large enough to hide your face from the prying eyes of the wastes."
	icon_state = "puristhood"
	item_state = "puristhood"
	flags_inv = HIDEHAIR|HIDEEARS|HIDEFACE

/obj/item/clothing/suit/hooded/extremistrobes
	name = "Black hooded robes"
	desc = "Deep black colored robes with a large hood to obscure the wearer's face, primarily to protect their clothing from harsh desert elements and to traverse the wastes anonymously."
	icon_state = "extremistrobes"
	item_state = "extremistrobes"
	togglename = "hood"
	allowed = list(/obj/item/weapon/dnainjector)
	body_parts_covered = ARMS|CHEST
	hoodtype = /obj/item/clothing/head/hooded/extremisthood
	pockets = /obj/item/weapon/storage/internal/pocket/big/coat

/obj/item/clothing/head/hooded/extremisthood
	name = "Hood"
	desc = "The hood of a deep black colored robe large enough to hide your face from the prying eyes of the wastes."
	icon_state = "extremisthood"
	item_state = "extremisthood"
	flags_inv = HIDEHAIR|HIDEEARS|HIDEFACE
...
/obj/item/clothing/suit/furyjacket
	name = "bedraggled leather jacket"
	desc = "What used to be an MFP uniform jacket, before one sleeve was removed and the shoulder armored."
	icon_state = "furyjacket"
	item_state = "furyjacket"
...
/obj/item/clothing/suit/scribe //Robes are made of finest cloth, so you won't be able to put sharp objects but pens in.
	name = "Scribe Robes"
	desc = "A red cloth robe with shining yellow highlights, traditionally worn by the Brotherhood of Steel Scribes."
	icon_state = "scriberobe"
	item_state = "scriberobe"
	body_parts_covered = CHEST|ARMS
	self_weight = 5

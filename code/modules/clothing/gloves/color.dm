...
/obj/item/clothing/gloves/pennywisegloves
	name = "Clown gloves"
	desc = "Puffy white victorian clown gloves, for doling out balloons or horrified screams."
	icon_state = "pennywisegloves"
	item_state = "pennywisegloves"
	item_color="pennywisegloves"
	flags = NODROP

/obj/item/clothing/gloves/newpennywisegloves
	name = "Clown gloves"
	desc = "Puffy victorian clown gloves, for doling out balloons or horrified screams."
	icon_state = "newpennywisegloves"
	item_state = "newpennywisegloves"
	item_color="pennywisegloves"
	flags = NODROP
